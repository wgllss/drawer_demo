...
public class ViewPagerSample extends FragmentActivity {
	...
	protected void onCreate(Bundle inState) {
		...
		mViewPager.setOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
			...
			public void onPageSelected(final int position) {
				// mMenuDrawer.setTouchMode(position == 0 ? MenuDrawer.TOUCH_MODE_FULLSCREEN : MenuDrawer.TOUCH_MODE_NONE);
			}
		});
	...
	public static class TextViewFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
			...
			frameLayout.setLayoutParams(new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, FrameLayout.LayoutParams.MATCH_PARENT, Gravity.CENTER));
